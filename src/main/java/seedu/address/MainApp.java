...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s address book, recipe book
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        return new ModelManager(initialAddressBook, initialRecipeBook, userPrefs);
    }
