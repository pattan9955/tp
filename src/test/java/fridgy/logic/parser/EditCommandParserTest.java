...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // while parsing {@code PREFIX_TAG} alone will reset the tags of the {@code RecipeIngredient} being edited,
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditCommand.EditIngredientDescriptor descriptor = new EditIngredientDescriptorBuilder().withPhone(CommandTestUtil.VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditIngredientDescriptorBuilder().withPhone(CommandTestUtil.VALID_PHONE_AMY).build();
        ...
        descriptor = new EditIngredientDescriptorBuilder().withAddress(CommandTestUtil.VALID_ADDRESS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        CommandParserTestUtil.assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditCommand.EditIngredientDescriptor descriptor = new EditIngredientDescriptorBuilder().withPhone(CommandTestUtil.VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        CommandParserTestUtil.assertParseSuccess(parser, userInput, expectedCommand);
        ...
        descriptor = new EditIngredientDescriptorBuilder().withPhone(CommandTestUtil.VALID_PHONE_BOB).withEmail(CommandTestUtil.VALID_EMAIL_BOB)
