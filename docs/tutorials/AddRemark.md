...
/**
 * Changes the remark of an existing ingredient in the address book.
 */
...
``` java
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Edits the remark of the ingredient identified "
            + "by the index number used in the last ingredient listing. "
...
public class RemarkCommand extends Command {
    ...
    /**
     * @param index of the ingredient in the filtered ingredient list to edit the remark
     * @param remark of the ingredient to be updated to
     */
...
Simply add the following to [`IngredientCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).
...
Then insert the following into [`main/resources/view/IngredientListCard.fxml`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-12580431f55d7880578aa4c16f249e71).
...
:bulb: Use the `Find Usages` feature in IntelliJ IDEA on the `Ingredient` class to find these commands.
